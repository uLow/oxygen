...
namespace oxygen\sql\table;
    ...
    use oxygen\sql\builder\Builder;

    class Table extends ScopeController {
                    ...
                    if(is_integer($key)) {
                        ...
                        if ($column === '*') {
                            foreach($this->model['columns'] as $col) {
                                $columnValue = Builder::safeName($alias . '.' . $col['name']);
                                $columnAlias = Builder::compoundAlias($alias, $col['name']);
                                $this->__assert(
                            ...
                            $columnValue = Builder::safeName($alias . '.' . $column);
                            $columnAlias = Builder::compoundAlias($alias, $column);
                        }
                    } else {
                        $columnAlias = Builder::compoundAlias($alias, $key);
