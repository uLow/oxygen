...
namespace oxygen\router;
    ...
    use oxygen\collection\Collection;
    ...
    class Router extends Collection {
        ...
        private $autoRoute = '';
        private $_wrap = false;
        private $_unwrap = false;

        public $type = self::COLLECTION;

        public function refine($data) {
            return $this->scope->Router($this->pattern, $data, $this->_wrap, $this->_unwrap);
        }
        ...
        public function wrap($obj){
            $x = &$obj;
            return call_user_func($this->wrap,$x);
        }
        ...
        public function getIterator() {
            $this->ensureAuto();
            return $this->scope->{'oxygen\\router\\iterator\\Iterator'}($this);
        }
