...
//                require_once $path;
            ...
            $this->scope->__introduce($class);
            $this->loaded[$class] = true;
            //echo "<pre>".print_r($this->loaded, 1)."</pre><hr>";
        }
...
//            $trial_path = $dir . DIRECTORY_SEPARATOR . $resource;\
            ...
            $trial_path = CURRENT_ROOT_PATH . DIRECTORY_SEPARATOR . implode(DIRECTORY_SEPARATOR, $classParts) . DIRECTORY_SEPARATOR . $resource;
//            echo $trial_path."<br>";
...
//            //$path = $this->classRoot . $path;
            ...
            $classParts = explode('\\', $class);
            $base = substr($class, -1) === self::BASE_SUFFIX;
            $last = $classParts[count($classParts)-1];
            unset($classParts[count($classParts)-1]);
            $path = CURRENT_ROOT_PATH . DIRECTORY_SEPARATOR . implode(DIRECTORY_SEPARATOR, $classParts);
