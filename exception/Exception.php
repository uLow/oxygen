...
namespace oxygen\exception;
    ...
    class Exception extends \Exception {
        ...
        protected $previous;
        private $current_call = null;

        public function __construct($message = "", $code=0, $previous = null) {
            $this->current_call = Oxygen::peek();
        ...
        // COPY-PASTE BLOCK FROM Object (Here we have to inherit from Exception)
        // TODO: in php 5.4 this should be refactored with traits
        // begin Copy-Paste block:


        const OBJECT_CLASS    = 'oxygen\Object';
        const EXCEPTION_CLASS = 'oxygen\exception\Exception';
        const SCOPE_CLASS     = 'oxygen\Scope';
        ...
        public function __call($method, $args) {
            if($this->getName() === 'RedirectException'){
